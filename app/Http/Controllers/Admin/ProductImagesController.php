...
class ProductImagesController extends Controller
{
    ...
    {        
        ...
        $breadcrumb='productImages';
        return view('admin.partials.catalogs.products.images.main', compact('images','breadcrumb','slug', 'item'));
    }
    ...
    public function edit($slug, $id)
    {
        ...
        $breadcrumb='productImages.edit';
        $item=$image;
        return view('admin.partials.catalogs.products.images.form', compact('image','breadcrumb','item', 'parent'));
    }
    ...
    public function update(ProductImageRequest $request, $slug, $id)
    {
        ...
        return redirect(route("admin-product-images", ['slug' => $image->product->slug]));
    }
    ...
    {    
        ...
        if (session()->has('adminItemsUrl')) return redirect(session()->get('adminItemsUrl'));
        return redirect(route("admin-product-images", ['slug' => $entity->product->slug]));
    }
    ...
    public function destroy($slug, $id)
    {
        ...
        if (session()->has('adminItemsUrl')) return redirect(session()->get('adminItemsUrl'));     
        return redirect(route("admin-product-images", ['slug' => $slug]));
    }
}
